...
<body>
	...
	<form name="fileForm" method="post" enctype="multipart/form-data"
		...
		카테고리 : <input
			type="checkbox" name="cate" value="Java" />Java <input
			type="checkbox" name="cate" value="JSP" />JSP <input type="checkbox"
			name="cate" value="Python" />Python <input type="checkbox"
			name="cate" value="AI" /> AI <br />
